	...
	foreach ($data['events'] as $event)
	{
		...
		if(strtolower($userMessage) == "learning path"){
			$ImageCarouselTemplateBuilder = new \LINE\LINEBot\MessageBuilder\TemplateBuilder\ImageCarouselTemplateBuilder([
			  ...
			  new \LINE\LINEBot\TemplateActionBuilder\UriTemplateActionBuilder('Buka Browser',"https://www.dicoding.com/learningpaths/2")),
			  ...
			  new \LINE\LINEBot\TemplateActionBuilder\UriTemplateActionBuilder('Buka Browser',"https://www.dicoding.com/learningpaths/22")),
			  ...
			  new \LINE\LINEBot\TemplateActionBuilder\UriTemplateActionBuilder('Buka Browser',"https://www.dicoding.com/learningpaths/23")),
			  ...
			  new \LINE\LINEBot\TemplateActionBuilder\UriTemplateActionBuilder('Buka Browser',"https://www.dicoding.com/learningpaths/13")),
			  ...
			  new \LINE\LINEBot\TemplateActionBuilder\UriTemplateActionBuilder('Buka Browser',"https://www.dicoding.com/learningpaths/17")),
